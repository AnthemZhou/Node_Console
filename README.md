...
- Uses colored category blocks in search results to hint at the node type while keeping the node name highlight separate.
...
1. Use the generated `Node_Console_0.8.18.zip`.
