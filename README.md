...
![Version](https://img.shields.io/badge/version-0.8.25-blue)
...
1. Download `Node_Console_0.8.25.zip` from the release assets.
...
1. 从 release assets 下载 `Node_Console_0.8.25.zip`。
